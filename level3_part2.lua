...
local function AddCollisionListeners()
    ...
    -- if character collides with lollipop, onCollision will be called
    lollipop1.collision = onCollision
    lollipop1:addEventListener( "collision" )

    -- if character collides with lollipop, onCollision will be called
    lollipop2.collision = onCollision
    lollipop2:addEventListener( "collision" )

    -- if character collides with lollipop, onCollision will be called
    lollipop3.collision = onCollision
    lollipop3:addEventListener( "collision" )

    -- if character collides with lollipop, onCollision will be called
    lollipop4.collision = onCollision
    lollipop4:addEventListener( "collision" )
...
local function RemoveCollisionListeners()
    ...
    lollipop1:removeEventListener( "collision" )
    lollipop2:removeEventListener( "collision" )
    lollipop3:removeEventListener( "collision" )
    lollipop4:removeEventListener( "collision" )
